create table team (id bigint not null auto_increment,starttime datetime, endtime datetime, maxstudentsenrolled integer,quality varchar(255),course_id bigint, primary key (id) );
create table student(id bigint not null auto_increment, firstname varchar(255), lastname varchar(255), contact_id bigint, primary key (id)  );
